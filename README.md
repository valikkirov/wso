...
Копируем код, который находится между комментариями и вставляем в редактор OpenCart, переключившись на вкладку "Исходный код".
...
2.2. Отступ между блоками. Вставляется код, который создает пустое место между блоками. Вставляем необходимое количество, чтобы получить заданный отступ.
...
Колонки разбиты для удобства, чтобы понимать где начинается и заканчивается колонка и установлены комментарии. Редактирование колонки:
...
>Чтобы добавить дополнительные колонки, необходимо внутри блока скопировать код колонки и вставить его после последней колонки. Соответственно, чтобы убрать колонки, нужно удалить код колонки. Чтобы не ошибиться каждая колонка закомментирована. 
...
>Чтобы добавить дополнительные колонки, необходимо внутри блока скопировать код колонки и вставить его после последней колонки. Соответственно, чтобы убрать колонки, нужно удалить код колонки.
